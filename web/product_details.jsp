...
<div id="welcomeLine" class="row">
	...
	<div class="pull-right">
		...
		<a href="product_summary.jsp" ><span id="cartUpdate" class="btn btn-mini btn-primary"><i class="icon-shopping-cart icon-white"></i> [  ] Itemes in your cart </span> </a> 
	</div>
	</div>
</div>
<!-- Navbar ================================================== -->
...
<!-- Sidebar ================================================== -->
	<div id="sidebar" class="span3">
		<div class="well well-small"><a  href="product_summary.jsp"><img src="themes/images/ico-cart.png" alt="cart">3 Items in your cart  <span class="badge badge-warning pull-right">$155.00</span></a></div>
				...
				<form class="form-horizontal qtyFrm">
				  <div class="control-group">
					...
					<input type="number" class="span1" placeholder="Qty."/>
					  <button type="button" class="btn btn-large btn-primary pull-right" onclick="updateCart()" > Add to cart <i class=" icon-shopping-cart"></i></button>
					</div>
				  </div>
				</form>
